...
export async function getWeather() {
  ...
  try {
    const url = `https://api.open-meteo.com/v1/forecast?latitude=${LATITUDE}&longitude=${LONGITUDE}&current=temperature_2m,apparent_temperature,rain,weather_code,wind_speed_10m&daily=temperature_2m_max,temperature_2m_min,precipitation_probability_max,weather_code&timezone=Europe/London&forecast_days=1`;
    ...
    const weather = {
      ...
      suggestedWeatherTag:
        c.temperature_2m >= 25 ? "Hot" :
        c.temperature_2m >= 18 ? "Warm" :
        c.temperature_2m >= 12 ? "Mild" : "Cold",
